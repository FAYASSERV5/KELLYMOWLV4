/* Copyright (c) Yusuf Usta & FAYASSERV5
Licenced under GNU
...
module.exports = {
    VERSION: 'v3.0.0',
    CHANNEL: 'undefined',
    SESSION: process.env.KELLYMOWLV4_CODE === undefined ? '' : process.env.KELLYMOWLV4_CODE,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'KELLYMOWL' : process.env.OWNER_NAME,
    ...
    SKDL: process.env.DIALOGUE === undefined ? '❤️‍🔥 POWER VIBES❤️‍🔥' : process.env.DIALOGUE,
    BLOCKMSG: process.env.BLOCK_MESSAGE === undefined ? 'default' : process.env.BLOCK_MESSAGE,
    UNBLOCKMSG: process.env.UNBLOCK_MESSAGE === undefined ? 'default' : process.env.UNBLOCK_MESSAGE,
    SOURAV: process.env.SK_BLOCK === undefined ? 'false' : process.env.SK_BLOCK,
    FAYASSERV5: process.env.STICKER_DATA === undefined ? 'sᴏᴜʀᴀᴠᴋʟ¹¹|ʀᴀɢᷨᴀͦɴͭᴏʀᴋ' : process.env.STICKER_DATA,
